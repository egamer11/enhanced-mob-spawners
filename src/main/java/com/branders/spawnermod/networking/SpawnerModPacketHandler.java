...
public class SpawnerModPacketHandler {
	...
	public static void register() {
        ...
        INSTANCE.registerMessage(messageId++,
        		UpgradeSpawnerMessage.class,
        		UpgradeSpawnerMessage::encode,
        		UpgradeSpawnerMessage::decode,
        		UpgradeSpawnerMessage::handle);

        INSTANCE.registerMessage(messageId++,
        		SyncPreciseSpawnerMessage.class,
        		SyncPreciseSpawnerMessage::encode,
        		SyncPreciseSpawnerMessage::decode,
        		SyncPreciseSpawnerMessage::handle);
    }
}
