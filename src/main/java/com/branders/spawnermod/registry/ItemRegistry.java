...
public class ItemRegistry {
	...
	public static final RegistryObject<Item> PRECISE_SPAWNER = ITEMS.register(
			"precise_spawner", () -> new BlockItem(BlockRegistry.PRECISE_SPAWNER.get(), new Item.Properties().rarity(Rarity.EPIC)));
